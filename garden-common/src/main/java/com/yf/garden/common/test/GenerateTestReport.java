package com.yf.garden.common.test;
 ...
 * @author 张继生
 */
public class GenerateTestReport implements IReporter {
	private Logger logger = LoggerFactory.getLogger(GenerateTestReport.class);
	private String path = System.getProperty("user.dir")+File.separator+"reportTest.html";
	...
	public GenerateTestReport(String name){
		this.name = name;
		if(this.name==null){
			SimpleDateFormat formatter = new SimpleDateFormat ("yyyyMMddHHmmssSSS");
